...
def parser_Alimentos(url): 
    ...
    if response.status_code == 200:
        ...
        if table:
            ...
            desired_columns = ['Valor energético (kcal)', 'Proteína', 'Gorduras totais', 'Carboidratos (por diferença)', 'Colesterol', 'Fibra alimentar', 'Gorduras saturadas', 'Sódio']
